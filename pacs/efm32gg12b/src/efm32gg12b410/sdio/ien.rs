...
pub type CMDCOMSEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, IEN_SPEC, bool, O>;
...
pub type TRANCOMSEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, IEN_SPEC, bool, O>;
...
pub type BLKGAPEVTSEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, IEN_SPEC, bool, O>;
...
pub type DMAINTSEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, IEN_SPEC, bool, O>;
...
pub type BUFWRRDYSEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, IEN_SPEC, bool, O>;
...
pub type BUFRDRDYSEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, IEN_SPEC, bool, O>;
...
pub type CARDINSSEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, IEN_SPEC, bool, O>;
...
pub type CARDREMSEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, IEN_SPEC, bool, O>;
...
pub type CARDINTSEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, IEN_SPEC, bool, O>;
...
pub type RETUNINGEVTSEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, IEN_SPEC, bool, O>;
...
pub type BOOTACKRCVSEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, IEN_SPEC, bool, O>;
...
pub type BOOTTERMINATESEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, IEN_SPEC, bool, O>;
...
pub type CMDTOUTERRSEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, IEN_SPEC, bool, O>;
...
pub type CMDCRCERRSEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, IEN_SPEC, bool, O>;
...
pub type CMDENDBITERRSEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, IEN_SPEC, bool, O>;
...
pub type CMDINDEXERRSEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, IEN_SPEC, bool, O>;
...
pub type DATTOUTERRSEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, IEN_SPEC, bool, O>;
...
pub type DATCRCERRSEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, IEN_SPEC, bool, O>;
...
pub type DATENDBITERRSEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, IEN_SPEC, bool, O>;
...
pub type CURRENTLIMITERRSEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, IEN_SPEC, bool, O>;
...
pub type AUTOCMDERRSEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, IEN_SPEC, bool, O>;
...
pub type ADMAERRSEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, IEN_SPEC, bool, O>;
...
pub type TUNINGERRSIGNALENABLE_W<'a, const O: u8> = crate::BitWriter<'a, u32, IEN_SPEC, bool, O>;
...
pub type TARGETRESPERRSEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, IEN_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmdcomsen(&mut self) -> CMDCOMSEN_W<0> {
        CMDCOMSEN_W::new(self)
    }
    #[doc = "Bit 1 - Transfer Complete Signal Enable"]
    #[inline(always)]
    #[must_use]
    pub fn trancomsen(&mut self) -> TRANCOMSEN_W<1> {
        TRANCOMSEN_W::new(self)
    }
    #[doc = "Bit 2 - Block Gap Event Signal Enable"]
    #[inline(always)]
    #[must_use]
    pub fn blkgapevtsen(&mut self) -> BLKGAPEVTSEN_W<2> {
        BLKGAPEVTSEN_W::new(self)
    }
    #[doc = "Bit 3 - DMA Interrupt Signal Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dmaintsen(&mut self) -> DMAINTSEN_W<3> {
        DMAINTSEN_W::new(self)
    }
    #[doc = "Bit 4 - Buffer Write Ready Signal Enable"]
    #[inline(always)]
    #[must_use]
    pub fn bufwrrdysen(&mut self) -> BUFWRRDYSEN_W<4> {
        BUFWRRDYSEN_W::new(self)
    }
    #[doc = "Bit 5 - Buffer Read Ready Signal Enable"]
    #[inline(always)]
    #[must_use]
    pub fn bufrdrdysen(&mut self) -> BUFRDRDYSEN_W<5> {
        BUFRDRDYSEN_W::new(self)
    }
    #[doc = "Bit 6 - Card Insertion Signal Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cardinssen(&mut self) -> CARDINSSEN_W<6> {
        CARDINSSEN_W::new(self)
    }
    #[doc = "Bit 7 - Card Removal Signal Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cardremsen(&mut self) -> CARDREMSEN_W<7> {
        CARDREMSEN_W::new(self)
    }
    #[doc = "Bit 8 - Card Interrupt Signal Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cardintsen(&mut self) -> CARDINTSEN_W<8> {
        CARDINTSEN_W::new(self)
    }
    #[doc = "Bit 12 - Re-Tuning Event Signal Enable"]
    #[inline(always)]
    #[must_use]
    pub fn retuningevtsen(&mut self) -> RETUNINGEVTSEN_W<12> {
        RETUNINGEVTSEN_W::new(self)
    }
    #[doc = "Bit 13 - Boot Ack Received Signal Enable"]
    #[inline(always)]
    #[must_use]
    pub fn bootackrcvsen(&mut self) -> BOOTACKRCVSEN_W<13> {
        BOOTACKRCVSEN_W::new(self)
    }
    #[doc = "Bit 14 - Boot Terminate Interrupt Signal Enable"]
    #[inline(always)]
    #[must_use]
    pub fn bootterminatesen(&mut self) -> BOOTTERMINATESEN_W<14> {
        BOOTTERMINATESEN_W::new(self)
    }
    #[doc = "Bit 16 - Command Timeout Error Signal Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cmdtouterrsen(&mut self) -> CMDTOUTERRSEN_W<16> {
        CMDTOUTERRSEN_W::new(self)
    }
    #[doc = "Bit 17 - Command CRC Error Signal Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cmdcrcerrsen(&mut self) -> CMDCRCERRSEN_W<17> {
        CMDCRCERRSEN_W::new(self)
    }
    #[doc = "Bit 18 - Command End Bit Error Signal Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cmdendbiterrsen(&mut self) -> CMDENDBITERRSEN_W<18> {
        CMDENDBITERRSEN_W::new(self)
    }
    #[doc = "Bit 19 - Command Index Error Signal Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cmdindexerrsen(&mut self) -> CMDINDEXERRSEN_W<19> {
        CMDINDEXERRSEN_W::new(self)
    }
    #[doc = "Bit 20 - Data Timeout Error Signal Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dattouterrsen(&mut self) -> DATTOUTERRSEN_W<20> {
        DATTOUTERRSEN_W::new(self)
    }
    #[doc = "Bit 21 - Data CRC Error Signal Enable"]
    #[inline(always)]
    #[must_use]
    pub fn datcrcerrsen(&mut self) -> DATCRCERRSEN_W<21> {
        DATCRCERRSEN_W::new(self)
    }
    #[doc = "Bit 22 - Data End Bit Error Signal Enable"]
    #[inline(always)]
    #[must_use]
    pub fn datendbiterrsen(&mut self) -> DATENDBITERRSEN_W<22> {
        DATENDBITERRSEN_W::new(self)
    }
    #[doc = "Bit 23 - Current Limit Error Signal Enable"]
    #[inline(always)]
    #[must_use]
    pub fn currentlimiterrsen(&mut self) -> CURRENTLIMITERRSEN_W<23> {
        CURRENTLIMITERRSEN_W::new(self)
    }
    #[doc = "Bit 24 - Auto CMD12 Error Signal Enable"]
    #[inline(always)]
    #[must_use]
    pub fn autocmderrsen(&mut self) -> AUTOCMDERRSEN_W<24> {
        AUTOCMDERRSEN_W::new(self)
    }
    #[doc = "Bit 25 - ADMA Error Signal Enable"]
    #[inline(always)]
    #[must_use]
    pub fn admaerrsen(&mut self) -> ADMAERRSEN_W<25> {
        ADMAERRSEN_W::new(self)
    }
    #[doc = "Bit 26 - Tuning Error Signal Enable"]
    #[inline(always)]
    #[must_use]
    pub fn tuningerrsignalenable(&mut self) -> TUNINGERRSIGNALENABLE_W<26> {
        TUNINGERRSIGNALENABLE_W::new(self)
    }
    #[doc = "Bit 28 - Target Response Error Signal Enable"]
    #[inline(always)]
    #[must_use]
    pub fn targetresperrsen(&mut self) -> TARGETRESPERRSEN_W<28> {
