...
pub mod lfeclksel;
#[doc = "LFCCLKSEL (rw) register accessor: an alias for `Reg<LFCCLKSEL_SPEC>`"]
...
pub mod adcctrl;
#[doc = "SDIOCTRL (rw) register accessor: an alias for `Reg<SDIOCTRL_SPEC>`"]
pub type SDIOCTRL = crate::Reg<sdioctrl::SDIOCTRL_SPEC>;
#[doc = "SDIO Control Register"]
pub mod sdioctrl;
#[doc = "QSPICTRL (rw) register accessor: an alias for `Reg<QSPICTRL_SPEC>`"]
pub type QSPICTRL = crate::Reg<qspictrl::QSPICTRL_SPEC>;
#[doc = "QSPI Control Register"]
pub mod qspictrl;
#[doc = "PDMCTRL (rw) register accessor: an alias for `Reg<PDMCTRL_SPEC>`"]
