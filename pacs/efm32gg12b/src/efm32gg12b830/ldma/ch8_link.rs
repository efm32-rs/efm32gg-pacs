...
pub type LINK_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH8_LINK_SPEC, bool, O>;
...
pub type LINKADDR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CH8_LINK_SPEC, u32, u32, 30, O>;
impl R {
