...
pub mod ramctrl;
#[doc = "ECCCTRL (rw) register accessor: an alias for `Reg<ECCCTRL_SPEC>`"]
pub type ECCCTRL = crate::Reg<eccctrl::ECCCTRL_SPEC>;
#[doc = "RAM ECC Control Register"]
pub mod eccctrl;
#[doc = "RAMECCADDR (r) register accessor: an alias for `Reg<RAMECCADDR_SPEC>`"]
pub type RAMECCADDR = crate::Reg<rameccaddr::RAMECCADDR_SPEC>;
#[doc = "RAM ECC Error Address Register"]
pub mod rameccaddr;
#[doc = "RAM1ECCADDR (r) register accessor: an alias for `Reg<RAM1ECCADDR_SPEC>`"]
pub type RAM1ECCADDR = crate::Reg<ram1eccaddr::RAM1ECCADDR_SPEC>;
#[doc = "RAM1 ECC Error Address Register"]
pub mod ram1eccaddr;
#[doc = "RAM2ECCADDR (r) register accessor: an alias for `Reg<RAM2ECCADDR_SPEC>`"]
