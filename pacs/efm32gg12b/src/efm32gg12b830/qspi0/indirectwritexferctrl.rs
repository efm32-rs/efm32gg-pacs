...
pub type START_W<'a, const O: u8> = crate::BitWriter<'a, u32, INDIRECTWRITEXFERCTRL_SPEC, bool, O>;
#[doc = "Field `CANCEL` writer - Cancel Indirect Write"]
pub type CANCEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, INDIRECTWRITEXFERCTRL_SPEC, bool, O>;
...
pub type INDOPSDONESTATUS_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, INDIRECTWRITEXFERCTRL_SPEC, bool, O>;
