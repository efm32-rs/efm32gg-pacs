...
pub type PRSSTARTSEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, PRSSEL_SPEC, u8, PRSSTARTSEL_A, 4, O>;
...
pub type PRSSTOPSEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, PRSSEL_SPEC, u8, PRSSTOPSEL_A, 4, O>;
...
pub type PRSCLEARSEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, PRSSEL_SPEC, u8, PRSCLEARSEL_A, 4, O>;
