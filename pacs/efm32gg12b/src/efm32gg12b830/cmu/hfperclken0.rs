...
pub type PDM_W<'a, const O: u8> = crate::BitWriter<'a, u32, HFPERCLKEN0_SPEC, bool, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn usart4(&mut self) -> USART4_W<4> {
        USART4_W::new(self)
    }
    #[doc = "Bit 5 - Timer 0 Clock Enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn acmp2(&mut self) -> ACMP2_W<11> {
        ACMP2_W::new(self)
    }
    #[doc = "Bit 12 - I2C 0 Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn i2c0(&mut self) -> I2C0_W<12> {
        I2C0_W::new(self)
    }
    #[doc = "Bit 13 - I2C 1 Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn i2c1(&mut self) -> I2C1_W<13> {
        I2C1_W::new(self)
    }
    #[doc = "Bit 14 - Analog to Digital Converter 0 Clock Enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn adc1(&mut self) -> ADC1_W<15> {
        ADC1_W::new(self)
    }
    #[doc = "Bit 16 - PDM Interface Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pdm(&mut self) -> PDM_W<16> {
        PDM_W::new(self)
    }
    #[doc = "Bit 17 - CRYOTIMER Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cryotimer(&mut self) -> CRYOTIMER_W<17> {
        CRYOTIMER_W::new(self)
    }
    #[doc = "Bit 18 - Current Digital to Analog Converter 0 Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn idac0(&mut self) -> IDAC0_W<18> {
        IDAC0_W::new(self)
    }
    #[doc = "Bit 19 - True Random Number Generator 0 Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn trng0(&mut self) -> TRNG0_W<19> {
        TRNG0_W::new(self)
    }
