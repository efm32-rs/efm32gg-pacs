...
pub type USBCREN_W<'a, const O: u8> = crate::BitWriter<'a, u32, USBCRCTRL_SPEC, bool, O>;
...
pub type USBLSCRMD_W<'a, const O: u8> = crate::BitWriter<'a, u32, USBCRCTRL_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn usbcren(&mut self) -> USBCREN_W<0> {
        USBCREN_W::new(self)
    }
    #[doc = "Bit 1 - Low Speed Clock Recovery Mode"]
    #[inline(always)]
    #[must_use]
    pub fn usblscrmd(&mut self) -> USBLSCRMD_W<1> {
