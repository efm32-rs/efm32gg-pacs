...
pub type ADDRSETUP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ADDRTIMING1_SPEC, u8, u8, 3, O>;
...
pub type ADDRHOLD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ADDRTIMING1_SPEC, u8, u8, 3, O>;
