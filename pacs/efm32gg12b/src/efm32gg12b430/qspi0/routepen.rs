...
pub type RST0PEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, ROUTEPEN_SPEC, bool, O>;
#[doc = "Field `RST1PEN` reader - RST1 Pin Enable"]
pub type RST1PEN_R = crate::BitReader<bool>;
#[doc = "Field `RST1PEN` writer - RST1 Pin Enable"]
pub type RST1PEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, ROUTEPEN_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rst0pen(&mut self) -> RST0PEN_W<16> {
        RST0PEN_W::new(self)
    }
    #[doc = "Bit 17 - RST1 Pin Enable"]
    #[inline(always)]
    #[must_use]
    pub fn rst1pen(&mut self) -> RST1PEN_W<17> {
        RST1PEN_W::new(self)
    }
