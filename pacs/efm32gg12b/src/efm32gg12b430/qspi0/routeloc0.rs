...
pub type QSPILOC_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, ROUTELOC0_SPEC, u8, QSPILOC_A, 6, O>;
impl<'a, const O: u8> QSPILOC_W<'a, O> {
    #[doc = "Location 0"]
    #[inline(always)]
...
pub type QSPIRSTLOC_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, ROUTELOC0_SPEC, u8, QSPIRSTLOC_A, 6, O>;
impl<'a, const O: u8> QSPIRSTLOC_W<'a, O> {
    #[doc = "Location 0"]
    #[inline(always)]
    pub fn loc0(self) -> &'a mut W {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn qspiloc(&mut self) -> QSPILOC_W<0> {
        QSPILOC_W::new(self)
    }
    #[doc = "Bits 6:11 - I/O Location"]
    #[inline(always)]
    #[must_use]
    pub fn qspirstloc(&mut self) -> QSPIRSTLOC_W<6> {
