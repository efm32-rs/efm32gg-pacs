...
pub type DEVICESTATUSNBDUMMY_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, POLLINGFLASHSTATUS_SPEC, u8, u8, 4, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn devicestatusnbdummy(&mut self) -> DEVICESTATUSNBDUMMY_W<16> {
