...
pub type RDSETUP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RDTIMING_SPEC, u8, u8, 3, O>;
...
pub type RDSTRB_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RDTIMING_SPEC, u8, u8, 7, O>;
#[doc = "Field `RDHOLD` reader - Read Hold Time"]
pub type RDHOLD_R = crate::FieldReader<u8, u8>;
#[doc = "Field `RDHOLD` writer - Read Hold Time"]
pub type RDHOLD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RDTIMING_SPEC, u8, u8, 3, O>;
