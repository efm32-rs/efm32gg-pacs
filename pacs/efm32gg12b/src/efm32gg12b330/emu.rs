...
pub mod vmonio0ctrl;
#[doc = "VMONIO1CTRL (rw) register accessor: an alias for `Reg<VMONIO1CTRL_SPEC>`"]
...
pub mod buctrl;
#[doc = "R5VCTRL (rw) register accessor: an alias for `Reg<R5VCTRL_SPEC>`"]
pub type R5VCTRL = crate::Reg<r5vctrl::R5VCTRL_SPEC>;
#[doc = "5V Regulator Control"]
pub mod r5vctrl;
#[doc = "R5VADCCTRL (rw) register accessor: an alias for `Reg<R5VADCCTRL_SPEC>`"]
pub type R5VADCCTRL = crate::Reg<r5vadcctrl::R5VADCCTRL_SPEC>;
#[doc = "5V Regulator Control"]
pub mod r5vadcctrl;
#[doc = "R5VOUTLEVEL (rw) register accessor: an alias for `Reg<R5VOUTLEVEL_SPEC>`"]
pub type R5VOUTLEVEL = crate::Reg<r5voutlevel::R5VOUTLEVEL_SPEC>;
#[doc = "5V Regulator Voltage Select"]
pub mod r5voutlevel;
#[doc = "R5VDETCTRL (rw) register accessor: an alias for `Reg<R5VDETCTRL_SPEC>`"]
...
#[doc = "R5VSTATUS (r) register accessor: an alias for `Reg<R5VSTATUS_SPEC>`"]
pub type R5VSTATUS = crate::Reg<r5vstatus::R5VSTATUS_SPEC>;
#[doc = "5V Detector Status Register"]
pub mod r5vstatus;
#[doc = "R5VSYNC (r) register accessor: an alias for `Reg<R5VSYNC_SPEC>`"]
