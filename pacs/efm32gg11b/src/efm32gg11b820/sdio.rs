...
#[doc = "SDMASYSADDR (rw) register accessor: an alias for `Reg<SDMASYSADDR_SPEC>`"]
pub type SDMASYSADDR = crate::Reg<sdmasysaddr::SDMASYSADDR_SPEC>;
#[doc = "SDMA System Address Register"]
pub mod sdmasysaddr;
#[doc = "BLKSIZE (rw) register accessor: an alias for `Reg<BLKSIZE_SPEC>`"]
pub type BLKSIZE = crate::Reg<blksize::BLKSIZE_SPEC>;
#[doc = "Block Size and Block Count Register"]
pub mod blksize;
#[doc = "CMDARG1 (rw) register accessor: an alias for `Reg<CMDARG1_SPEC>`"]
pub type CMDARG1 = crate::Reg<cmdarg1::CMDARG1_SPEC>;
#[doc = "SD Command Argument Register"]
pub mod cmdarg1;
#[doc = "TFRMODE (rw) register accessor: an alias for `Reg<TFRMODE_SPEC>`"]
...
pub mod resp4;
#[doc = "RESP6 (r) register accessor: an alias for `Reg<RESP6_SPEC>`"]
pub type RESP6 = crate::Reg<resp6::RESP6_SPEC>;
#[doc = "Response6 and Response7 Register"]
pub mod resp6;
#[doc = "BUFDATPORT (rw) register accessor: an alias for `Reg<BUFDATPORT_SPEC>`"]
...
pub mod prsstat;
#[doc = "HOSTCTRL1 (rw) register accessor: an alias for `Reg<HOSTCTRL1_SPEC>`"]
pub type HOSTCTRL1 = crate::Reg<hostctrl1::HOSTCTRL1_SPEC>;
#[doc = "Host Control1, Power, Block Gap and Wakeup-up Control Register"]
pub mod hostctrl1;
#[doc = "CLOCKCTRL (rw) register accessor: an alias for `Reg<CLOCKCTRL_SPEC>`"]
...
pub mod ifcr;
#[doc = "IFENC (rw) register accessor: an alias for `Reg<IFENC_SPEC>`"]
...
pub mod cfg1;
#[doc = "CFGPRESETVAL0 (rw) register accessor: an alias for `Reg<CFGPRESETVAL0_SPEC>`"]
...
#[doc = "CFGPRESETVAL1 (rw) register accessor: an alias for `Reg<CFGPRESETVAL1_SPEC>`"]
...
#[doc = "CFGPRESETVAL2 (rw) register accessor: an alias for `Reg<CFGPRESETVAL2_SPEC>`"]
...
#[doc = "CFGPRESETVAL3 (rw) register accessor: an alias for `Reg<CFGPRESETVAL3_SPEC>`"]
