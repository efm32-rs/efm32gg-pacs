...
pub type OPCODE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, WRITECOMPLETIONCTRL_SPEC, u8, u8, 8, O>;
...
pub type POLLINGBITINDEX_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, WRITECOMPLETIONCTRL_SPEC, u8, u8, 3, O>;
...
pub type POLLINGPOLARITY_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, WRITECOMPLETIONCTRL_SPEC, bool, O>;
...
pub type DISABLEPOLLING_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, WRITECOMPLETIONCTRL_SPEC, bool, O>;
...
pub type POLLREPDELAY_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, WRITECOMPLETIONCTRL_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:7 - Opcode"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pollingbitindex(&mut self) -> POLLINGBITINDEX_W<8> {
        POLLINGBITINDEX_W::new(self)
    }
    #[doc = "Bit 13 - Polling Polarity"]
    #[inline(always)]
    #[must_use]
    pub fn pollingpolarity(&mut self) -> POLLINGPOLARITY_W<13> {
        POLLINGPOLARITY_W::new(self)
    }
    #[doc = "Bit 14 - Disable Polling"]
    #[inline(always)]
    #[must_use]
    pub fn disablepolling(&mut self) -> DISABLEPOLLING_W<14> {
        DISABLEPOLLING_W::new(self)
    }
    #[doc = "Bit 15 - Enable Polling Expiration"]
    #[inline(always)]
    #[must_use]
    pub fn enablepollingexp(&mut self) -> ENABLEPOLLINGEXP_W<15> {
        ENABLEPOLLINGEXP_W::new(self)
    }
    #[doc = "Bits 16:23 - Poll Count"]
    #[inline(always)]
    #[must_use]
    pub fn pollcount(&mut self) -> POLLCOUNT_W<16> {
        POLLCOUNT_W::new(self)
    }
    #[doc = "Bits 24:31 - Poll Repetition Delay"]
    #[inline(always)]
    #[must_use]
    pub fn pollrepdelay(&mut self) -> POLLREPDELAY_W<24> {
