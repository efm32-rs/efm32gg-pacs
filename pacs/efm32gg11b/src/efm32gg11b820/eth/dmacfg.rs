...
pub type AMBABRSTLEN_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DMACFG_SPEC, u8, u8, 5, O>;
...
pub type HDRDATASPLITEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMACFG_SPEC, bool, O>;
...
pub type RXPBUFSIZE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, DMACFG_SPEC, u8, RXPBUFSIZE_A, 2, O>;
...
pub type TXPBUFSIZE_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMACFG_SPEC, bool, O>;
...
pub type TXPBUFTCPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMACFG_SPEC, bool, O>;
...
pub type INFLASTDBUFSIZEEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMACFG_SPEC, bool, O>;
...
pub type RXBUFSIZE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DMACFG_SPEC, u8, u8, 8, O>;
...
pub type FRCDISCARDONERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMACFG_SPEC, bool, O>;
...
pub type FRCMAXAMBABRSTRX_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMACFG_SPEC, bool, O>;
...
pub type FRCMAXAMBABRSTTX_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMACFG_SPEC, bool, O>;
...
pub type RXBDEXTNDMODEEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMACFG_SPEC, bool, O>;
...
pub type TXBDEXTENDMODEEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMACFG_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ambabrstlen(&mut self) -> AMBABRSTLEN_W<0> {
        AMBABRSTLEN_W::new(self)
    }
    #[doc = "Bit 5 - Enable header data Splitting."]
    #[inline(always)]
    #[must_use]
    pub fn hdrdataspliten(&mut self) -> HDRDATASPLITEN_W<5> {
        HDRDATASPLITEN_W::new(self)
    }
    #[doc = "Bits 8:9 - Receiver packet buffer memory size select."]
    #[inline(always)]
    #[must_use]
    pub fn rxpbufsize(&mut self) -> RXPBUFSIZE_W<8> {
        RXPBUFSIZE_W::new(self)
    }
    #[doc = "Bit 10 - Transmitter packet buffer memory size select."]
    #[inline(always)]
    #[must_use]
    pub fn txpbufsize(&mut self) -> TXPBUFSIZE_W<10> {
        TXPBUFSIZE_W::new(self)
    }
    #[doc = "Bit 11 - Transmitter IP, TCP and UDP checksum generation offload enable"]
    #[inline(always)]
    #[must_use]
    pub fn txpbuftcpen(&mut self) -> TXPBUFTCPEN_W<11> {
        TXPBUFTCPEN_W::new(self)
    }
    #[doc = "Bit 12 - Forces the DMA"]
    #[inline(always)]
    #[must_use]
    pub fn inflastdbufsizeen(&mut self) -> INFLASTDBUFSIZEEN_W<12> {
        INFLASTDBUFSIZEEN_W::new(self)
    }
    #[doc = "Bits 16:23 - DMA receive buffer size in external AMBA (AHB) system memory."]
    #[inline(always)]
    #[must_use]
    pub fn rxbufsize(&mut self) -> RXBUFSIZE_W<16> {
        RXBUFSIZE_W::new(self)
    }
    #[doc = "Bit 24 - Auto Discard RX pkts during lack of resource."]
    #[inline(always)]
    #[must_use]
    pub fn frcdiscardonerr(&mut self) -> FRCDISCARDONERR_W<24> {
        FRCDISCARDONERR_W::new(self)
    }
    #[doc = "Bit 25 - Force max length bursts on RX."]
    #[inline(always)]
    #[must_use]
    pub fn frcmaxambabrstrx(&mut self) -> FRCMAXAMBABRSTRX_W<25> {
        FRCMAXAMBABRSTRX_W::new(self)
    }
    #[doc = "Bit 26 - Force max length bursts on TX."]
    #[inline(always)]
    #[must_use]
    pub fn frcmaxambabrsttx(&mut self) -> FRCMAXAMBABRSTTX_W<26> {
        FRCMAXAMBABRSTTX_W::new(self)
    }
    #[doc = "Bit 28 - Enable RX extended BD mode."]
    #[inline(always)]
    #[must_use]
    pub fn rxbdextndmodeen(&mut self) -> RXBDEXTNDMODEEN_W<28> {
        RXBDEXTNDMODEEN_W::new(self)
    }
    #[doc = "Bit 29 - Enable TX extended BD mode."]
    #[inline(always)]
    #[must_use]
    pub fn txbdextendmodeen(&mut self) -> TXBDEXTENDMODEEN_W<29> {
