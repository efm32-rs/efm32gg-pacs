...
pub type STSPHSERCVD_W<'a, const O: u8> = crate::BitWriter<'a, u32, DOEP3_INT_SPEC, bool, O>;
...
pub type OUTPKTERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, DOEP3_INT_SPEC, bool, O>;
...
pub type STUPPKTRCVD_W<'a, const O: u8> = crate::BitWriter<'a, u32, DOEP3_INT_SPEC, bool, O>;
impl R {
