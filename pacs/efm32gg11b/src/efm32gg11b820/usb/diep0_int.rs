...
pub type INTKNEPMIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, DIEP0_INT_SPEC, bool, O>;
...
pub type TXFIFOUNDRN_W<'a, const O: u8> = crate::BitWriter<'a, u32, DIEP0_INT_SPEC, bool, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn intknepmis(&mut self) -> INTKNEPMIS_W<5> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn txfifoundrn(&mut self) -> TXFIFOUNDRN_W<8> {
