...
pub type ADLOC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ROUTELOC1_SPEC, u8, ADLOC_A, 6, O>;
impl<'a, const O: u8> ADLOC_W<'a, O> {
    #[doc = "Location 0"]
    #[inline(always)]
...
pub type ALOC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ROUTELOC1_SPEC, u8, ALOC_A, 6, O>;
...
pub type RDYLOC_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, ROUTELOC1_SPEC, u8, RDYLOC_A, 6, O>;
impl<'a, const O: u8> RDYLOC_W<'a, O> {
    #[doc = "Location 0"]
    #[inline(always)]
    pub fn loc0(self) -> &'a mut W {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn adloc(&mut self) -> ADLOC_W<0> {
        ADLOC_W::new(self)
    }
    #[doc = "Bits 8:13 - I/O Location"]
    #[inline(always)]
    #[must_use]
    pub fn aloc(&mut self) -> ALOC_W<8> {
        ALOC_W::new(self)
    }
    #[doc = "Bits 16:21 - I/O Location"]
    #[inline(always)]
    #[must_use]
    pub fn rdyloc(&mut self) -> RDYLOC_W<16> {
        RDYLOC_W::new(self)
    }
