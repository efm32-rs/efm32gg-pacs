...
pub type VMONIO1FALL_W<'a, const O: u8> = crate::BitWriter<'a, u32, IFS_SPEC, bool, O>;
#[doc = "Field `VMONIO1RISE` writer - Set VMONIO1RISE Interrupt Flag"]
pub type VMONIO1RISE_W<'a, const O: u8> = crate::BitWriter<'a, u32, IFS_SPEC, bool, O>;
#[doc = "Field `R5VREADY` writer - Set R5VREADY Interrupt Flag"]
pub type R5VREADY_W<'a, const O: u8> = crate::BitWriter<'a, u32, IFS_SPEC, bool, O>;
...
pub type R5VVSINT_W<'a, const O: u8> = crate::BitWriter<'a, u32, IFS_SPEC, bool, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn vmonio1fall(&mut self) -> VMONIO1FALL_W<8> {
        VMONIO1FALL_W::new(self)
    }
    #[doc = "Bit 9 - Set VMONIO1RISE Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn vmonio1rise(&mut self) -> VMONIO1RISE_W<9> {
        VMONIO1RISE_W::new(self)
    }
    #[doc = "Bit 10 - Set R5VREADY Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn r5vready(&mut self) -> R5VREADY_W<10> {
        R5VREADY_W::new(self)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn r5vvsint(&mut self) -> R5VVSINT_W<23> {
        R5VVSINT_W::new(self)
    }
