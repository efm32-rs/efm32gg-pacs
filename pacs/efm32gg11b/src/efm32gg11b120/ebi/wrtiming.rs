...
pub type WRSETUP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, WRTIMING_SPEC, u8, u8, 3, O>;
...
pub type WRSTRB_W<'a, const O: u8> = crate::FieldWriter<'a, u32, WRTIMING_SPEC, u8, u8, 7, O>;
#[doc = "Field `WRHOLD` reader - Write Hold Time"]
pub type WRHOLD_R = crate::FieldReader<u8, u8>;
#[doc = "Field `WRHOLD` writer - Write Hold Time"]
pub type WRHOLD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, WRTIMING_SPEC, u8, u8, 3, O>;
