...
pub type DCLKPERIOD_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TFTTIMING_SPEC, u16, u16, 12, O>;
...
pub type TFTSTART_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TFTTIMING_SPEC, u16, u16, 12, O>;
...
pub type TFTSETUP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TFTTIMING_SPEC, u8, u8, 3, O>;
#[doc = "Field `TFTHOLD` reader - TFT Hold Time"]
pub type TFTHOLD_R = crate::FieldReader<u8, u8>;
#[doc = "Field `TFTHOLD` writer - TFT Hold Time"]
pub type TFTHOLD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TFTTIMING_SPEC, u8, u8, 3, O>;
impl R {
