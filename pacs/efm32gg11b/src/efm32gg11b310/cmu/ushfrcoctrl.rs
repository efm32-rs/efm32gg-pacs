...
pub type FINETUNING_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, USHFRCOCTRL_SPEC, u8, u8, 6, O>;
...
pub type FREQRANGE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, USHFRCOCTRL_SPEC, u8, u8, 5, O>;
...
pub type CMPBIAS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, USHFRCOCTRL_SPEC, u8, u8, 3, O>;
...
pub type LDOHP_W<'a, const O: u8> = crate::BitWriter<'a, u32, USHFRCOCTRL_SPEC, bool, O>;
...
pub type CLKDIV_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, USHFRCOCTRL_SPEC, u8, CLKDIV_A, 2, O>;
...
pub type FINETUNINGEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, USHFRCOCTRL_SPEC, bool, O>;
...
pub type VREFTC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, USHFRCOCTRL_SPEC, u8, u8, 4, O>;
impl R {
