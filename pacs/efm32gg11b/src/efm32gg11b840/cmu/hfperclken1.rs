...
pub type WTIMER2_W<'a, const O: u8> = crate::BitWriter<'a, u32, HFPERCLKEN1_SPEC, bool, O>;
...
pub type WTIMER3_W<'a, const O: u8> = crate::BitWriter<'a, u32, HFPERCLKEN1_SPEC, bool, O>;
...
pub type UART1_W<'a, const O: u8> = crate::BitWriter<'a, u32, HFPERCLKEN1_SPEC, bool, O>;
...
pub type CAN1_W<'a, const O: u8> = crate::BitWriter<'a, u32, HFPERCLKEN1_SPEC, bool, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wtimer0(&mut self) -> WTIMER0_W<0> {
        WTIMER0_W::new(self)
    }
    #[doc = "Bit 1 - Wide Timer 0 Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn wtimer1(&mut self) -> WTIMER1_W<1> {
        WTIMER1_W::new(self)
    }
    #[doc = "Bit 2 - Wide Timer 2 Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn wtimer2(&mut self) -> WTIMER2_W<2> {
        WTIMER2_W::new(self)
    }
    #[doc = "Bit 3 - Wide Timer 3 Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn wtimer3(&mut self) -> WTIMER3_W<3> {
        WTIMER3_W::new(self)
    }
    #[doc = "Bit 4 - Universal Asynchronous Receiver/Transmitter 0 Clock Enable"]
    #[inline(always)]
