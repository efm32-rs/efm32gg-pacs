...
pub type TIMER4_W<'a, const O: u8> = crate::BitWriter<'a, u32, HFPERCLKEN0_SPEC, bool, O>;
...
pub type TIMER5_W<'a, const O: u8> = crate::BitWriter<'a, u32, HFPERCLKEN0_SPEC, bool, O>;
...
pub type TIMER6_W<'a, const O: u8> = crate::BitWriter<'a, u32, HFPERCLKEN0_SPEC, bool, O>;
...
pub type USART4_W<'a, const O: u8> = crate::BitWriter<'a, u32, HFPERCLKEN0_SPEC, bool, O>;
...
pub type USART5_W<'a, const O: u8> = crate::BitWriter<'a, u32, HFPERCLKEN0_SPEC, bool, O>;
...
pub type ACMP2_W<'a, const O: u8> = crate::BitWriter<'a, u32, HFPERCLKEN0_SPEC, bool, O>;
...
pub type ACMP3_W<'a, const O: u8> = crate::BitWriter<'a, u32, HFPERCLKEN0_SPEC, bool, O>;
...
pub type I2C2_W<'a, const O: u8> = crate::BitWriter<'a, u32, HFPERCLKEN0_SPEC, bool, O>;
...
pub type ADC1_W<'a, const O: u8> = crate::BitWriter<'a, u32, HFPERCLKEN0_SPEC, bool, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn timer3(&mut self) -> TIMER3_W<3> {
        TIMER3_W::new(self)
    }
    #[doc = "Bit 4 - Timer 4 Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn timer4(&mut self) -> TIMER4_W<4> {
        TIMER4_W::new(self)
    }
    #[doc = "Bit 5 - Timer 5 Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn timer5(&mut self) -> TIMER5_W<5> {
        TIMER5_W::new(self)
    }
    #[doc = "Bit 6 - Timer 6 Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn timer6(&mut self) -> TIMER6_W<6> {
        TIMER6_W::new(self)
    }
    #[doc = "Bit 7 - Universal Synchronous/Asynchronous Receiver/Transmitter 0 Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn usart0(&mut self) -> USART0_W<7> {
        USART0_W::new(self)
    }
    #[doc = "Bit 8 - Universal Synchronous/Asynchronous Receiver/Transmitter 1 Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn usart1(&mut self) -> USART1_W<8> {
        USART1_W::new(self)
    }
    #[doc = "Bit 9 - Universal Synchronous/Asynchronous Receiver/Transmitter 2 Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn usart2(&mut self) -> USART2_W<9> {
        USART2_W::new(self)
    }
    #[doc = "Bit 10 - Universal Synchronous/Asynchronous Receiver/Transmitter 3 Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn usart3(&mut self) -> USART3_W<10> {
        USART3_W::new(self)
    }
    #[doc = "Bit 11 - Universal Synchronous/Asynchronous Receiver/Transmitter 4 Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn usart4(&mut self) -> USART4_W<11> {
        USART4_W::new(self)
    }
    #[doc = "Bit 12 - Universal Synchronous/Asynchronous Receiver/Transmitter 5 Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn usart5(&mut self) -> USART5_W<12> {
        USART5_W::new(self)
    }
    #[doc = "Bit 13 - Analog Comparator 0 Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn acmp0(&mut self) -> ACMP0_W<13> {
        ACMP0_W::new(self)
    }
    #[doc = "Bit 14 - Analog Comparator 1 Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn acmp1(&mut self) -> ACMP1_W<14> {
        ACMP1_W::new(self)
    }
    #[doc = "Bit 15 - Analog Comparator 1 Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn acmp2(&mut self) -> ACMP2_W<15> {
        ACMP2_W::new(self)
    }
    #[doc = "Bit 16 - Analog Comparator 3 Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn acmp3(&mut self) -> ACMP3_W<16> {
        ACMP3_W::new(self)
    }
    #[doc = "Bit 17 - I2C 0 Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn i2c0(&mut self) -> I2C0_W<17> {
        I2C0_W::new(self)
    }
    #[doc = "Bit 18 - I2C 1 Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn i2c1(&mut self) -> I2C1_W<18> {
        I2C1_W::new(self)
    }
    #[doc = "Bit 19 - I2C 2 Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn i2c2(&mut self) -> I2C2_W<19> {
        I2C2_W::new(self)
    }
    #[doc = "Bit 20 - Analog to Digital Converter 0 Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn adc0(&mut self) -> ADC0_W<20> {
        ADC0_W::new(self)
    }
    #[doc = "Bit 21 - Analog to Digital Converter 0 Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn adc1(&mut self) -> ADC1_W<21> {
        ADC1_W::new(self)
    }
    #[doc = "Bit 22 - CRYOTIMER Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cryotimer(&mut self) -> CRYOTIMER_W<22> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn trng0(&mut self) -> TRNG0_W<24> {
        TRNG0_W::new(self)
    }
