...
pub type MATCH_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SPECTYPE4_SPEC, u16, u16, 16, O>;
...
pub type ENBCOPY_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPECTYPE4_SPEC, bool, O>;
impl R {
