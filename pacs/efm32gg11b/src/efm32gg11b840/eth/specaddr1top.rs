...
pub type ADDR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SPECADDR1TOP_SPEC, u16, u16, 16, O>;
...
pub type FILTERTYPE_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPECADDR1TOP_SPEC, bool, O>;
impl R {
