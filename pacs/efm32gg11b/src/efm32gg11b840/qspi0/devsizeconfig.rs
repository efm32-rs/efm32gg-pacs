...
pub type NUMADDRBYTES_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DEVSIZECONFIG_SPEC, u8, u8, 4, O>;
...
pub type BYTESPERDEVICEPAGE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DEVSIZECONFIG_SPEC, u16, u16, 12, O>;
...
pub type BYTESPERSUBSECTOR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DEVSIZECONFIG_SPEC, u8, u8, 5, O>;
...
Pin"]
pub type MEMSIZEONCS0_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DEVSIZECONFIG_SPEC, u8, u8, 2, O>;
...
Pin"]
pub type MEMSIZEONCS1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DEVSIZECONFIG_SPEC, u8, u8, 2, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn numaddrbytes(&mut self) -> NUMADDRBYTES_W<0> {
        NUMADDRBYTES_W::new(self)
    }
    #[doc = "Bits 4:15 - Number of Bytes Per Device Page"]
    #[inline(always)]
    #[must_use]
    pub fn bytesperdevicepage(&mut self) -> BYTESPERDEVICEPAGE_W<4> {
        BYTESPERDEVICEPAGE_W::new(self)
    }
    #[doc = "Bits 16:20 - Number of Bytes Per Block"]
    #[inline(always)]
    #[must_use]
    pub fn bytespersubsector(&mut self) -> BYTESPERSUBSECTOR_W<16> {
...
Pin"]
    #[inline(always)]
    #[must_use]
    pub fn memsizeoncs0(&mut self) -> MEMSIZEONCS0_W<21> {
...
Pin"]
    #[inline(always)]
    #[must_use]
    pub fn memsizeoncs1(&mut self) -> MEMSIZEONCS1_W<23> {
