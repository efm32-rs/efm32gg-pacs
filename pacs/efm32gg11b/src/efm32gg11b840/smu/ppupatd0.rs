...
pub type ACMP2_W<'a, const O: u8> = crate::BitWriter<'a, u32, PPUPATD0_SPEC, bool, O>;
...
pub type ACMP3_W<'a, const O: u8> = crate::BitWriter<'a, u32, PPUPATD0_SPEC, bool, O>;
...
pub type ADC1_W<'a, const O: u8> = crate::BitWriter<'a, u32, PPUPATD0_SPEC, bool, O>;
...
pub type CAN1_W<'a, const O: u8> = crate::BitWriter<'a, u32, PPUPATD0_SPEC, bool, O>;
...
pub type EBI_W<'a, const O: u8> = crate::BitWriter<'a, u32, PPUPATD0_SPEC, bool, O>;
...
pub type ETH_W<'a, const O: u8> = crate::BitWriter<'a, u32, PPUPATD0_SPEC, bool, O>;
...
pub type I2C2_W<'a, const O: u8> = crate::BitWriter<'a, u32, PPUPATD0_SPEC, bool, O>;
...
pub type LETIMER1_W<'a, const O: u8> = crate::BitWriter<'a, u32, PPUPATD0_SPEC, bool, O>;
...
pub type LEUART1_W<'a, const O: u8> = crate::BitWriter<'a, u32, PPUPATD0_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn acmp2(&mut self) -> ACMP2_W<2> {
        ACMP2_W::new(self)
    }
    #[doc = "Bit 3 - Analog Comparator 3 access control bit"]
    #[inline(always)]
    #[must_use]
    pub fn acmp3(&mut self) -> ACMP3_W<3> {
        ACMP3_W::new(self)
    }
    #[doc = "Bit 4 - Analog to Digital Converter 0 access control bit"]
    #[inline(always)]
    #[must_use]
    pub fn adc0(&mut self) -> ADC0_W<4> {
        ADC0_W::new(self)
    }
    #[doc = "Bit 5 - Analog to Digital Converter 0 access control bit"]
    #[inline(always)]
    #[must_use]
    pub fn adc1(&mut self) -> ADC1_W<5> {
        ADC1_W::new(self)
    }
    #[doc = "Bit 6 - CAN 0 access control bit"]
    #[inline(always)]
    #[must_use]
    pub fn can0(&mut self) -> CAN0_W<6> {
        CAN0_W::new(self)
    }
    #[doc = "Bit 7 - CAN 1 access control bit"]
    #[inline(always)]
    #[must_use]
    pub fn can1(&mut self) -> CAN1_W<7> {
        CAN1_W::new(self)
    }
    #[doc = "Bit 8 - Clock Management Unit access control bit"]
    #[inline(always)]
    #[must_use]
    pub fn cmu(&mut self) -> CMU_W<8> {
        CMU_W::new(self)
    }
    #[doc = "Bit 9 - CRYOTIMER access control bit"]
    #[inline(always)]
    #[must_use]
    pub fn cryotimer(&mut self) -> CRYOTIMER_W<9> {
        CRYOTIMER_W::new(self)
    }
    #[doc = "Bit 10 - Advanced Encryption Standard Accelerator access control bit"]
    #[inline(always)]
    #[must_use]
    pub fn crypto0(&mut self) -> CRYPTO0_W<10> {
        CRYPTO0_W::new(self)
    }
    #[doc = "Bit 11 - Capacitive touch sense module access control bit"]
    #[inline(always)]
    #[must_use]
    pub fn csen(&mut self) -> CSEN_W<11> {
        CSEN_W::new(self)
    }
    #[doc = "Bit 12 - Digital to Analog Converter 0 access control bit"]
    #[inline(always)]
    #[must_use]
    pub fn vdac0(&mut self) -> VDAC0_W<12> {
        VDAC0_W::new(self)
    }
    #[doc = "Bit 13 - Peripheral Reflex System access control bit"]
    #[inline(always)]
    #[must_use]
    pub fn prs(&mut self) -> PRS_W<13> {
        PRS_W::new(self)
    }
    #[doc = "Bit 14 - External Bus Interface access control bit"]
    #[inline(always)]
    #[must_use]
    pub fn ebi(&mut self) -> EBI_W<14> {
        EBI_W::new(self)
    }
    #[doc = "Bit 15 - Energy Management Unit access control bit"]
    #[inline(always)]
    #[must_use]
    pub fn emu(&mut self) -> EMU_W<15> {
        EMU_W::new(self)
    }
    #[doc = "Bit 16 - Ethernet Controller access control bit"]
    #[inline(always)]
    #[must_use]
    pub fn eth(&mut self) -> ETH_W<16> {
        ETH_W::new(self)
    }
    #[doc = "Bit 17 - FPU Exception Handler access control bit"]
    #[inline(always)]
    #[must_use]
    pub fn fpueh(&mut self) -> FPUEH_W<17> {
        FPUEH_W::new(self)
    }
    #[doc = "Bit 18 - General Purpose CRC access control bit"]
    #[inline(always)]
    #[must_use]
    pub fn gpcrc(&mut self) -> GPCRC_W<18> {
        GPCRC_W::new(self)
    }
    #[doc = "Bit 19 - General purpose Input/Output access control bit"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn i2c0(&mut self) -> I2C0_W<20> {
        I2C0_W::new(self)
    }
    #[doc = "Bit 21 - I2C 1 access control bit"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn idac0(&mut self) -> IDAC0_W<23> {
        IDAC0_W::new(self)
    }
    #[doc = "Bit 24 - Memory System Controller access control bit"]
    #[inline(always)]
    #[must_use]
    pub fn msc(&mut self) -> MSC_W<24> {
        MSC_W::new(self)
    }
    #[doc = "Bit 25 - Liquid Crystal Display Controller access control bit"]
    #[inline(always)]
    #[must_use]
    pub fn lcd(&mut self) -> LCD_W<25> {
        LCD_W::new(self)
    }
    #[doc = "Bit 26 - Linked Direct Memory Access Controller access control bit"]
    #[inline(always)]
    #[must_use]
    pub fn ldma(&mut self) -> LDMA_W<26> {
        LDMA_W::new(self)
    }
    #[doc = "Bit 27 - Low Energy Sensor Interface access control bit"]
    #[inline(always)]
    #[must_use]
    pub fn lesense(&mut self) -> LESENSE_W<27> {
        LESENSE_W::new(self)
    }
    #[doc = "Bit 28 - Low Energy Timer 0 access control bit"]
    #[inline(always)]
    #[must_use]
    pub fn letimer0(&mut self) -> LETIMER0_W<28> {
        LETIMER0_W::new(self)
    }
    #[doc = "Bit 29 - Low Energy Timer 1 access control bit"]
    #[inline(always)]
    #[must_use]
    pub fn letimer1(&mut self) -> LETIMER1_W<29> {
        LETIMER1_W::new(self)
    }
    #[doc = "Bit 30 - Low Energy UART 0 access control bit"]
    #[inline(always)]
    #[must_use]
    pub fn leuart0(&mut self) -> LEUART0_W<30> {
        LEUART0_W::new(self)
    }
    #[doc = "Bit 31 - Low Energy UART 1 access control bit"]
    #[inline(always)]
    #[must_use]
    pub fn leuart1(&mut self) -> LEUART1_W<31> {
        LEUART1_W::new(self)
    }
