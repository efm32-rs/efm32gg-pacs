...
pub type LEUART1DIS_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, EM23PERNORETAINCTRL_SPEC, bool, O>;
...
pub type LETIMER1DIS_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, EM23PERNORETAINCTRL_SPEC, bool, O>;
...
pub type I2C2DIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, EM23PERNORETAINCTRL_SPEC, bool, O>;
...
pub type ADC1DIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, EM23PERNORETAINCTRL_SPEC, bool, O>;
...
pub type ACMP2DIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, EM23PERNORETAINCTRL_SPEC, bool, O>;
...
pub type ACMP3DIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, EM23PERNORETAINCTRL_SPEC, bool, O>;
...
pub type RTCDIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, EM23PERNORETAINCTRL_SPEC, bool, O>;
...
pub type USBDIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, EM23PERNORETAINCTRL_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn leuart1dis(&mut self) -> LEUART1DIS_W<16> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn letimer1dis(&mut self) -> LETIMER1DIS_W<18> {
        LETIMER1DIS_W::new(self)
    }
    #[doc = "Bit 19 - Allow Power Down of I2C2 During EM23"]
    #[inline(always)]
    #[must_use]
    pub fn i2c2dis(&mut self) -> I2C2DIS_W<19> {
        I2C2DIS_W::new(self)
    }
    #[doc = "Bit 20 - Allow Power Down of ADC1 During EM23"]
    #[inline(always)]
    #[must_use]
    pub fn adc1dis(&mut self) -> ADC1DIS_W<20> {
        ADC1DIS_W::new(self)
    }
    #[doc = "Bit 21 - Allow Power Down of ACMP2 During EM23"]
    #[inline(always)]
    #[must_use]
    pub fn acmp2dis(&mut self) -> ACMP2DIS_W<21> {
        ACMP2DIS_W::new(self)
    }
    #[doc = "Bit 22 - Allow Power Down of ACMP3 During EM23"]
    #[inline(always)]
    #[must_use]
    pub fn acmp3dis(&mut self) -> ACMP3DIS_W<22> {
        ACMP3DIS_W::new(self)
    }
    #[doc = "Bit 23 - Allow Power Down of RTC During EM23"]
    #[inline(always)]
    #[must_use]
    pub fn rtcdis(&mut self) -> RTCDIS_W<23> {
        RTCDIS_W::new(self)
    }
    #[doc = "Bit 24 - Allow Power Down of USB During EM23"]
    #[inline(always)]
    #[must_use]
    pub fn usbdis(&mut self) -> USBDIS_W<24> {
        USBDIS_W::new(self)
    }
