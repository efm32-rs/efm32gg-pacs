...
pub type QUANTP6_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TXPAUSEQUANT3_SPEC, u16, u16, 16, O>;
...
pub type QUANTP7_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TXPAUSEQUANT3_SPEC, u16, u16, 16, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn quantp6(&mut self) -> QUANTP6_W<0> {
        QUANTP6_W::new(self)
    }
    #[doc = "Bits 16:31 - Transmit pause quantum - written with the pause quantum value for pause frame transmission of priority 7."]
    #[inline(always)]
    #[must_use]
    pub fn quantp7(&mut self) -> QUANTP7_W<16> {
        QUANTP7_W::new(self)
    }
