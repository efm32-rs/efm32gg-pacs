...
pub type EXTSTIGOPCODE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, OPCODEEXTLOWER_SPEC, u8, u8, 8, O>;
...
pub type EXTPOLLOPCODE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, OPCODEEXTLOWER_SPEC, u8, u8, 8, O>;
...
pub type EXTWRITEOPCODE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, OPCODEEXTLOWER_SPEC, u8, u8, 8, O>;
...
pub type EXTREADOPCODE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, OPCODEEXTLOWER_SPEC, u8, u8, 8, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn extstigopcode(&mut self) -> EXTSTIGOPCODE_W<0> {
        EXTSTIGOPCODE_W::new(self)
    }
    #[doc = "Bits 8:15 - Polling Opcode Extension"]
    #[inline(always)]
    #[must_use]
    pub fn extpollopcode(&mut self) -> EXTPOLLOPCODE_W<8> {
        EXTPOLLOPCODE_W::new(self)
    }
    #[doc = "Bits 16:23 - Write Opcode Extension"]
    #[inline(always)]
    #[must_use]
    pub fn extwriteopcode(&mut self) -> EXTWRITEOPCODE_W<16> {
        EXTWRITEOPCODE_W::new(self)
    }
    #[doc = "Bits 24:31 - Read Opcode Extension"]
    #[inline(always)]
    #[must_use]
    pub fn extreadopcode(&mut self) -> EXTREADOPCODE_W<24> {
